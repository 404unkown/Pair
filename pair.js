        ...
        browser: Browsers.windows('Edge'),
            ...
            Um4r719.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    let stringSession = `${megaUrl.replace('https://mega.nz/file/', '404-XMD;;;')}`;
                    ...
                    await Um4r719.sendMessage(Um4r719.user.id, { 
                        text: '404-XMD has been successfully linked...Above is your session id, Copy and paste it on the SESSION string during deploy as it will be used for authentication.\n\nAny issue reach me here https://wa.me/254769769295\n\nGoodluck 🎉.\n' 
                    });
