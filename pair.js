            ...
            Um4r719.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    await Um4r719.sendMessage(Um4r719.user.id, { 
                        text: 'MAD-MAX has been successfully linked...Above is your session id, Copy and paste it on the SESSION string during deploy as it will be used for authentication.\n\nAny issue reach me here https://wa.me/message/25769769295\n\nGoodluck 🥳.\n' 
                    });
